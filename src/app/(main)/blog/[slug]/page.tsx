...
import { Heading, Text, Column, Flex, Row, Line, CodeBlock } from "@once-ui-system/core";
...
export default async function BlogPost({ params }: BlogPostProps) {
  ...
  if (!fs.existsSync(filePath)) {
    return (
      <Column fillWidth center padding="128">
  ...
  const components = {
    ...
    h2: (props: any) => (
      <Heading variant="display-strong-xs" marginTop="32" marginBottom="16" {...props} />
    ),
    h3: (props: any) => (
      <Heading variant="heading-strong-l" marginTop="24" marginBottom="12" {...props} />
    ),
    h4: (props: any) => (
      <Heading variant="heading-strong-m" marginTop="20" marginBottom="8" {...props} />
    ),
    p: (props: any) => (
      <Text
    ...
    strong: (props: any) => (
      <strong
        style={{ fontWeight: "bold", color: "var(--neutral-on-background-strong)" }}
        {...props}
      />
    ),
    a: (props: any) => {
